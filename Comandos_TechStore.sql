...
SELECT  SUM(quantidade_vendida * preco) AS total_vendas
FROM relacional.VENDAS
JOIN relacional.produtos  ON produtos.id_produto= produtos.id_produto
-- JOIN relacional.pedidos  ON Itens_Pedido.id_pedido = pedidos.id_pedido
